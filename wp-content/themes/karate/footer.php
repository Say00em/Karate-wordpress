        ...
        <footer class="bg_dark footer_dark">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bottom_footer border_top_transparent">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="copyright m-md-0 text-center text-md-left">Copyright © 2024 - Template Made By <a href="https://synexdigital.com/" class="text_default">Synex Digital</a></p>
                                </div>
                                <div class="col-md-6">
            ...
            <div class="shape_img">
                <div class="ol_shape10">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/belt2.png" style="opacity: 0.3;" alt="shape36"/>
                </div>
            </div>
        </footer>
        <!-- END FOOTER -->
